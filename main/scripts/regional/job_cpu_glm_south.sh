...
#SBATCH --job-name=glm_south_cpu
#SBATCH --output=glm_south_cpu%j.log
#SBATCH --error=glm_south_cpu%j.log
#SBATCH --nodes=1
...
echo "Model: glm (SOUTH) | Train: $train | Validation: $validation"
echo "======================================"

CONFIG="/srv/data/mohammad.elaabaribao/work/papers/downscaling/main/configs/glm/regional/south.yaml"
