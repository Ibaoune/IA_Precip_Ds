...
#SBATCH --error=cnn_exp3_gpu%j.log
...
echo "Model: CNN (Exp 3) | Train: $train | Validation: $validation"
echo "======================================"

# GPU Info
nvidia-smi

gpu_log="gpu_usage_cnn_exp3_${SLURM_JOB_ID}.log"
nvidia-smi --query-gpu=timestamp,utilization.gpu,utilization.memory,memory.used \
 --format=csv,nounits,noheader \
 --loop=60 > "$gpu_log" &

CONFIG="../configs/cnn/cnn_exp3.yaml"
