...
#SBATCH --job-name=unet_tests
#SBATCH --output=unet_tests_%j.log
#SBATCH --error=unet_tests_%j.log
...
TESTS_DIR="../../../configs/unet/tests"

echo "Starting UNet tests from $TESTS_DIR"
