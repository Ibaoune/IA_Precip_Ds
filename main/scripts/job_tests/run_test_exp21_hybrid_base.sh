#!/bin/bash
#SBATCH --job-name=test_exp21_hybrid_base
#SBATCH --output=test_exp21_hybrid_base_%j.log
#SBATCH --error=test_exp21_hybrid_base_%j.log
...
CONFIG_PATH="../../configs/vit/tests/test_exp21_hybrid_base.yaml"
