...
#SBATCH --job-name=test_exp22_hybrid_deep_reg
#SBATCH --output=test_exp22_hybrid_deep_reg_%j.log
#SBATCH --error=test_exp22_hybrid_deep_reg_%j.log
...
CONFIG_PATH="../../../configs/vit/tests/test_exp22_hybrid_deep_reg.yaml"
