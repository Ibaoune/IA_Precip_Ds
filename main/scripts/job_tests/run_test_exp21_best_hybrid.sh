#!/bin/bash
#SBATCH --job-name=test_exp21_best_hybrid
#SBATCH --output=test_exp21_best_hybrid_%j.log
#SBATCH --error=test_exp21_best_hybrid_%j.log
...
CONFIG_PATH="../../configs/vit/tests/test_exp21_best_hybrid.yaml"
