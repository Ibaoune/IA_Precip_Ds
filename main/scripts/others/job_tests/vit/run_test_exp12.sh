...
#SBATCH --job-name=test_exp12
#SBATCH --output=test_exp12_%j.log
#SBATCH --error=test_exp12_%j.log
...
CONFIG_PATH="../../../configs/vit/tests/test_exp12.yaml"
...
echo "[INFO] Skipping training (already completed)..."
