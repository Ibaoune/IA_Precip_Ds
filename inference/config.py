...
class Config:
 ...
 ref = cfg_dict["dates"].get("reference", {})
 self.ref_start = str(ref.get("start", "1979-01-01"))
 self.ref_end = str(ref.get("end", "2005-12-31"))
 ...
 self.model_path = str(paths.get("model_path", ""))
 if self.model_path and not os.path.isabs(self.model_path) and self.root_dir:
