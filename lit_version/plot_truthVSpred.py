...
def spatial_comparaison_plot(
    ...
    for i, (data, title, stats) in enumerate([
        ...
        # STATS en dessous du titre (aligné)
        axs[i].text(
            0.5, 1.02,
...
def monthly_precip_comparaison_plot(
    ...
    if title_suffix:
        plt.suptitle(title_suffix, fontsize=9, style="italic", y=0.95)
...
def format_flags(flags, sep="_"):
    return sep.join([f"{k}={v}" for k, v in flags.items()])
...
if __name__ == "__main__":
    ...
    pred_path = "results/evaluation/config_nll_per_day_vit/inference_pred_2006-2020.nc"
    truth_path = "results/evaluation/config_nll_per_day_vit/inference_truth_2006-2020.nc"
    ...
    spatial_filename = f"figures/spatial_precip_2006_2020_{flag_str}.png"
    spatial_comparaison_plot(
        ...
        lat_values=lat,
        model_name="ViT",
        filename=spatial_filename,
        title_suffix=f"2006-2020 | {flag_str}",
    )

    monthly_filename = f"figures/monthly_precip_2006_2020_{flag_str}.png"
