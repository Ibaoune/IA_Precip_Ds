...
def main():
    ...
    for dat in datasets_to_evaluate:
        ...
        _, df = utils.compute_generic_metrics(
            ...
            threshold_mm=metric_cfg.get('threshold_mm', 1.0)
        )
    ...
    for period in plot_periods:
        ...
        ref_cdd = compute_cdd_flagged(dataset=ref_p, return_by_year=False, threshold_mm=metric_cfg.get('threshold_mm', 1.0))
