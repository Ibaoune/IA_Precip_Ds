...
Description: A robust climatological processor for extracting long-term station averages and visualizing inter-model temporal consistency.
"""
...
def main():
    ...
    plt.tight_layout()
    clim_path = os.path.join(out_dir, "annual_cycle_insitu.png")
    ...
    plt.tight_layout()
    taylor_path = os.path.join(out_dir, "taylor_diagram_insitu.png")
