...
Description: Calculates and visualizes the monthly climatological annual cycle comparing in-situ observations against multiple gridded downscaling models.
"""
...
def main():
    ...
    # SAVE
    # ==========================================================
    out_path = os.path.join(results_dir, "annual_cycle_insitu.png")
