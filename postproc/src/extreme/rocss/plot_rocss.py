...
def main():
 ...
 # ROCSS is 0 to 1 usually (can be negative). We use a custom colorbar logic in utils?
 # For now let's use default.
 utils.plot_spatial_maps(data_spatial, METRIC, period=period, save_path=spatial_path, unit="score")
 ...
 utils.plot_temporal_evolution(MODEL_PATHS_BASE, METRIC, period=period, save_path=evol_path, unit="score")
