...
def main():
    ...
    for val in raw_list:
        if isinstance(val, str):
            ...
            try:
                ...
                print(f"Warning: Could not parse CDD threshold '{val}' as float. Skipping.")
        else:
            try:
    ...
    for threshold_mm in thresholds:
        ...
        print(f"\n==========================================================")
        print(f"CDD Plotting: Running for threshold = {threshold_mm} mm")
        print(f"Data Directory: {DATA_RESULTS_DIR}")
        print(f"==========================================================")
