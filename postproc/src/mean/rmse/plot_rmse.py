...
def main():
    ...
    for period in plot_periods:
        ...
        utils.plot_spatial_maps(data_spatial, METRIC, period=period, save_path=spatial_path, unit="mm/day")
        ...
        utils.plot_temporal_evolution(MODEL_PATHS_BASE, METRIC, period=period, save_path=evol_path, unit="mm/day")
