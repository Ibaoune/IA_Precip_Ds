...
#SBATCH --job-name=eval_postproc_vit
#SBATCH --output=logs/eval_postproc_vit_%j.log
#SBATCH --error=logs/eval_postproc_vit_%j.log
#SBATCH --nodes=1
...
echo "======================================"
python3 -u src/postproc.py configs/experiments/config_vit_all.yaml
